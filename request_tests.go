...
func TestItAddsStringQueryParameters(t *testing.T) {
	...
	assert.Nil(t, requestInformation.QueryParameters["Filter"])
}
...
func TestItAddsBoolQueryParameters(t *testing.T) {
	...
	assert.Nil(t, requestInformation.QueryParameters["Count"])
}
...
func TestItAddsIntQueryParameters(t *testing.T) {
	...
	assert.Nil(t, requestInformation.QueryParameters["Top"])
}
...
func TestItAddsAnyArrayQueryParameters(t *testing.T) {
	...
	assert.Equal(t, []any{"somefilter", "someotherfilter"}, requestInformation.QueryParameters["ExpandAny"])
}
...
func TestItSetsUUIDPathParameters(t *testing.T) {
	...
	requestInformation.UrlTemplate = "http://localhost/users/{id}"
	value := uuid.MustParse("95E943B8-52D5-4228-902D-61D65792CED7")
	requestInformation.PathParameters["id"] = &value
	resultUri, err := requestInformation.GetUri()
	assert.Nil(t, err)
...
func TestItSetsEnumValueInPathParameters(t *testing.T) {
	...
	status := internal.ACTIVE
	requestInformation.PathParameters["baseurl"] = "http://localhost"
	requestInformation.PathParameters["status"] = &status
...
func TestItSetsEnumValuesInPathParameters(t *testing.T) {
	...
	statuses[1] = internal.SUSPENDED
	requestInformation.PathParameters["baseurl"] = "http://localhost"
	requestInformation.PathParameters["statuses"] = statuses
...
func prepareNormalizedStdTest(arrayValues any, singleValue any, referenceArray any, referenceValue any) *Request {
	requestInformation := NewRequestInformation()
	...
	requestInformation.PathParameters["baseurl"] = "http://localhost"
	requestInformation.PathParameters["arrayValues"] = arrayValues
	requestInformation.PathParameters["singleValue"] = singleValue
	requestInformation.PathParameters["referenceArray"] = referenceArray
	requestInformation.PathParameters["referenceValue"] = referenceValue
...
func (r *MockRequestAdapter) Send(context context.Context, requestInfo *Request, constructor s.ParsableFactory, errorMappings ErrorMappings) (s.Parsable, error) {
	return nil, nil
}
func (r *MockRequestAdapter) SendEnum(context context.Context, requestInfo *Request, parser s.EnumFactory, errorMappings ErrorMappings) (any, error) {
	return nil, nil
}
func (r *MockRequestAdapter) SendCollection(context context.Context, requestInfo *Request, constructor s.ParsableFactory, errorMappings ErrorMappings) ([]s.Parsable, error) {
	return nil, nil
}
func (r *MockRequestAdapter) SendEnumCollection(context context.Context, requestInfo *Request, parser s.EnumFactory, errorMappings ErrorMappings) ([]any, error) {
	return nil, nil
}
func (r *MockRequestAdapter) SendPrimitive(context context.Context, requestInfo *Request, typeName string, errorMappings ErrorMappings) (any, error) {
	return nil, nil
}
func (r *MockRequestAdapter) SendPrimitiveCollection(context context.Context, requestInfo *Request, typeName string, errorMappings ErrorMappings) ([]any, error) {
	return nil, nil
}
func (r *MockRequestAdapter) SendNoContent(context context.Context, requestInfo *Request, errorMappings ErrorMappings) error {
	return nil
}
func (r *MockRequestAdapter) ConvertToNativeRequest(context context.Context, requestInfo *Request) (any, error) {
	return nil, nil
}
